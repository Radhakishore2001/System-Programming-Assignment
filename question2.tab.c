...
{
      12,     0,    -1,    13,    -1,    13,    14,    13,    -1,     7,
      13,     8,    -1,    15,    -1,     3,    -1,     4,    -1,     5,
      -1,     6,    -1,     9,    -1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "PLUS", "MINUS", "TIMES", "FSLASH",
  "LPAREN", "RPAREN", "VARIABLE", "NUMBER", "$accept", "rootnode", "exp",
  "op", "term", 0
};
#endif
...
int main(){
    ...
    //rc = sqlite3_prepare_v2(db, temp, -1, &res, 0);
